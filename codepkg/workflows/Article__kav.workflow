...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>CTP_Assist/CTP_Email_Template_for_Knowledge_Submitted</template>
    </alerts>
    <alerts>
        <fullName>Email_Article_Approval</fullName>
        <description>Email after Article Approved</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
        ...
        <senderType>CurrentUser</senderType>
        <template>CTP_Assist/CTP_Email_Template_for_Knowledge_Published</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>CTP_Assist/CTP_Email_Template_for_Knowledge_Article_Rejection</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Notify_Knowledge_Manager_Require_Approval</fullName>
        <description>Email to legal team Submitted for Approval</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
