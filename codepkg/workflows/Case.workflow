...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>CTP_Assist_Severity_To_Green</fullName>
        <description>update severity to green</description>
        <field>CTP_Severity__c</field>
        <literalValue>Green</literalValue>
        <name>Severity To Green</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>CTP_Assist_Severity_To_Red</fullName>
        <description>update severity to red</description>
        <field>CTP_Severity__c</field>
        <literalValue>Red</literalValue>
        <name>Severity To Red</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>CTP_Assist_Severity_To_Yellow</fullName>
        <description>Workflow to update field update to yellow</description>
        <field>CTP_Severity__c</field>
        <literalValue>Yellow</literalValue>
        <name>Severity To Yellow</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>CTP_Assist_Update_Severity_To_Yellow</fullName>
        <description>Update Severity To Yellow</description>
        <field>CTP_Severity__c</field>
        <literalValue>Yellow</literalValue>
        <name>Update Severity To Yellow</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Injured_Person_details</fullName>
        <description>Injured Person contact details</description>
        <field>Subject</field>
        <formula>(&quot;CTP_InjuredPersonContact__c&quot;)&amp;&quot;-&quot;&amp;(&quot;OLCN_AccidentDate__c&quot;)</formula>
        <name>Injured Person details</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Insurer_Process_Status_to_Warm_transfer</fullName>
        <description>Insurer Process Status to Warm transfer</description>
        <field>OLCN_InsurerStatus__c</field>
        <literalValue>Warm Transfer</literalValue>
        <name>Insurer Process Status to Warm transfer</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <rules>
        <fullName>CTP Compensation To Relatives Entitlement Milestone 1</fullName>
        <actions>
            <name>CTP_Update_Due_Date_Lodgement</name>
            <type>FieldUpdate</type>
        </actions>
        ...
        <criteriaItems>
            <field>Case.RecordTypeId</field>
            <operation>equals</operation>
            <value>Compensation to Relatives</value>
        </criteriaItems>
        <criteriaItems>
            <field>Case.Status</field>
            <operation>equals</operation>
        ...
        <description>This workflow rule covers both immediate and time deferred workflow actions for the first milestone in the Compensation To Relatives Entitlement Process.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>CTP_Update_Next_Action_StatusMC</name>
            ...
            <actions>
                <name>CTP_Contact_the_Claimant</name>
                <type>Task</type>
            </actions>
            <offsetFromField>Case.CTP_LodgementDate__c</offsetFromField>
            <timeLength>-18</timeLength>
    ...
    <rules>
        <fullName>CTP Compensation To Relatives Entitlement Milestone 1 Test</fullName>
        <actions>
            <name>CTP_Update_Due_Date_Lodgement</name>
            <type>FieldUpdate</type>
        </actions>
        ...
        <description>This workflow rule covers both immediate and time deferred workflow actions for the first milestone in the Compensation To Relatives Entitlement Process.(Test Version)</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(RecordType.DeveloperName = &quot;Feedback&quot;, ISCHANGED(CTP_CaseType__c),ISPICKVAL(CTP_CaseType__c , &quot;DRS&quot;)  )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Injured Person details</fullName>
        <actions>
            <name>Injured_Person_details</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>Injured Person details .</description>
        <formula>CTP_InjuredPersonContact__c =  OLCN_ContactText__c  &amp;&amp;  CTP_Date_of_accident__c =  OLCN_AccidentDate__c</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <tasks>
